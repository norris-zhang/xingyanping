...
public class StatByClientDao extends BaseDao{

	public StatByClientDto execute(Date monthDate) throws SQLException {
		...
		try {
			...
			return new StatByClientDto().init(list, cprsList);
		} catch (Exception e) {
