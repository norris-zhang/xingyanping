...
update `client_port_relationship` set `cprs_order`=8 where `cprs_company_short_name`='陕西创远2' and `cprs_port` like '10690219%';
...
update `client_port_relationship` set `cprs_order`=14 where `cprs_company_short_name`='陕西创远1' and `cprs_port` like '106575681025%';
